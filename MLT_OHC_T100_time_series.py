...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 09:37:58 2020
...
plt.ylim([55,90])
#tDorian = np.tile(datetime(2019,8,28,18),len(np.arange(45,80))) #ng668
#plt.plot(tDorian,np.arange(45,80),'--k')
#plt.ylim([45,80])
...
plt.plot(time_GOFS,Tmean_dens_crit_GOFS,'s-',color='indianred',linewidth=2,label='GOFS 3.1',markeredgecolor='k',markersize=7)
plt.plot(timestamp_POM_oper,Tmean_dens_crit_POM_oper,'X-',color='mediumorchid',label='HWRF2019-POM (IC clim.)',markeredgecolor='k',markersize=7)
plt.plot(timestamp_POM_exp,Tmean_dens_crit_POM_exp,'^-',color='teal',linewidth=2,label='HWRF2020-POM (IC RTOFS)',markeredgecolor='k',markersize=7)
plt.plot(timestamp_HYCOM_exp,Tmean_dens_crit_HYCOM_exp,'H-',color='darkorange',linewidth=2,label='HWRF2020-HYCOM (IC RTOFS)',markeredgecolor='k',markersize=7)
t0 = datetime(2019,8,25)
deltat= timedelta(1)
xticks = [t0+nday*deltat for nday in np.arange(15)]
xticks = np.asarray(xticks)
...
#tDorian = np.tile(datetime(2019,8,28,18),len(np.arange(28,29.5,0.2)))# ng668
...
plt.xlim([time_POM_oper[0],time_POM_oper[-1]])
plt.ylabel('($^oC$)',fontsize = 14)
#tDorian = np.tile(datetime(2019,8,28,18),len(np.arange(27.0,28.7,0.1)))# ng668
#plt.plot(tDorian,np.arange(27.0,28.7,0.1),'--k')
tDorian = np.tile(datetime(2019,8,29,0),len(np.arange(27.6,28.6,0.01)))# ng665
plt.plot(tDorian,np.arange(27.6,28.6,0.01),'--k')
plt.ylim([27.6,28.6])
